    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Finance: tracking project finances, generating certificates, and managing cash flow in real time, so budget variance is visible while there's still time to correct it, not after the quarter closes.",
